...
function buttonClickEvent(button) {
  ...
  const category = button.target.dataset.category;
...
function createMenuItem({ id, title, category, price, img, desc }) {
  const menuElement = document.createElement('div');
  menuElement.classList.add('menu-item');
  menuElement.setAttribute('data-id', id);
  menuElement.setAttribute('data-category', category);
...
function renderMenuItems(category = 'All') {
  ...
  if (category == 'All') {
    ...
    filteredMenuItems = menu.filter(item => item.category === category);
  }
